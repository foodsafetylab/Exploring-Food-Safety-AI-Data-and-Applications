...
def hope_guardrail_perish(size, resource_perish, max_budget, xopt, x_lower, n, Lt, demand_dist, perish_dist, n_upper, order=None):
    """
    ...
    return perish_un_allocate, waste, counterfactual_envy, hindsight_envy, None
